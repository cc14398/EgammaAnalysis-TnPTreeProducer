...
submitVersion = "10Sep_WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8" # add some date here
...
mainOutputDir = '/store/user/ccooke/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/%s' % submitVersion 
