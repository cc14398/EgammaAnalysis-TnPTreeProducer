...
varOptions.register(
    ...
    "GT","106X_mcRun2_asymptotic_v17", ##MC UL2016
    VarParsing.multiplicity.singleton,
    VarParsing.varType.string,
...
## UL 2018
# options['TnPPATHS']            = cms.vstring("HLT_Ele32_WPTight_Gsf*") # was HLT_Ele32_WPTight_Gsf_v* here but other places are missing the _v so I removed it too
...
###################################################################
from EgammaAnalysis.TnPTreeProducer.etc.tnpInputTestFiles_cff import filesMiniAOD_Preliminary2016 as inputs
