...
submitVersion = "13Sep_TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8" # add some date here
...
mainOutputDir = '/store/user/ccooke/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/%s' % submitVersion 
