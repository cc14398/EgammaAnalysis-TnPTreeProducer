...
submitVersion = "13Sep_TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8" # add some date here
...
mainOutputDir = '/store/user/ccooke/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/%s' % submitVersion 
