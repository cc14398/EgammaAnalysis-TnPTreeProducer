...
submitVersion = "10Sep2021_All2017F" # add some date here
...
mainOutputDir = '/store/user/ccooke/10SepUL2017F/%s' % submitVersion 
...
config.Data.inputDataset = '/SingleElectron/Run2017F-09Aug2019_UL2017_rsb-v2/MINIAOD'
